...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#030712] flex items-center justify-center p-4 text-white font-sans">
      ...
      <div className="absolute top-[20%] left-[20%] w-[50%] h-[50%] rounded-full bg-cyan-900/20 blur-[120px] pointer-events-none"></div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="glass-panel rounded-3xl p-8 border border-white/10 bg-slate-900/50 backdrop-blur-xl shadow-2xl animate-fade-in-up">
          ...
          <p className="text-slate-400 mb-6 text-sm">Enter your credentials to access your secure dashboard.</p>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-700 bg-slate-950/50 px-4 py-3 text-white placeholder-slate-500 focus:border-cyan-500 focus:outline-none focus:ring-1 focus:ring-cyan-500 transition-colors"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full group relative flex h-12 items-center justify-center gap-2 rounded-xl bg-cyan-500 font-semibold text-slate-950 transition-all hover:bg-cyan-400 disabled:opacity-50 disabled:cursor-not-allowed mt-6"
            >
